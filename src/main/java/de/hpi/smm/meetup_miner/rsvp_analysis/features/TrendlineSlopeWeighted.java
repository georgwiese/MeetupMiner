...
public class TrendlineSlopeWeighted implements AbstractFeature {
	...
	public double forEvent(Event event, Collection<Event> pastEvents) {
		...
		EventNeighborhood neighborhood = new EventNeighborhood(event, pastEvents, EventWeighter.HALF_TIME_YEAR);
